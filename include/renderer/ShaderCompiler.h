...
public:
	...
	std::vector<std::string> ParseImports(const std::string& filePath, bool recurse = true);
	void ParseImportsRecursive(const std::string& filePath, std::unordered_set<std::string>& dependencies, bool recurse);
